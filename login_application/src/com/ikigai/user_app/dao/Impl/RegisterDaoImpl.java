...
public class RegisterDaoImpl implements IRegisterDao{
	 ...
	 * 
	 * Next it calls the executeUpdate() method to execute the query generated by the createPreparedStatement() method
	 * and update the record in the database.
	 * The executeUpdate() method returns a boolean value(true if the record has been updated) which is in turn 
